...
/** @type {string} */
const CACHE_VERSION = '1727497150|31482060';
/** @type {string} */
const CACHE_PREFIX = 'Epsilons-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Epsilons_web_godot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Epsilons_web_godot.html","Epsilons_web_godot.js","Epsilons_web_godot.offline.html","Epsilons_web_godot.icon.png","Epsilons_web_godot.apple-touch-icon.png","Epsilons_web_godot.worker.js","Epsilons_web_godot.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Epsilons_web_godot.wasm","Epsilons_web_godot.pck"];
